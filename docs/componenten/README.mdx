...
import {
  ...
  DefinitionTitle,
  DefinitionData,
} from "@site/src/components/DefinitionList";

import {
  ComponentCard,
  ComponentCards,
} from "@site/src/components/ComponentCards";
...
<DefinitionList>
  <Definition>
    ...
    <DefinitionData>
      Het compontent moet nog ontwikkeld worden, maar staat al wel op de
      backlog. Heeft jouw organisatie dit component nodig? Neem contact op en
      help ons om de eerste versie te ontwikkelen.
    </DefinitionData>
  </Definition>
  <Definition>
    <DefinitionTitle>Community</DefinitionTitle>
    <DefinitionData>
      Het component is beschikbaar in de community en is gebouwd volgens de
      architectuur en richtlijnen van NL Design System.
    </DefinitionData>
  </Definition>
  <Definition>
    <DefinitionTitle>Unstable</DefinitionTitle>
    <DefinitionData>
      Het component is beschikbaar in de NL Design System repository. Hij
      voldoet alleen nog niet aan onze "Definition of Done".
    </DefinitionData>
  </Definition>
  <Definition>
    <DefinitionTitle>Stable</DefinitionTitle>
    <DefinitionData>
      Het component is beschikbaar in de NL Design System repository en voldoet
      volledig aan onze "Definition of Done".
    </DefinitionData>
  </Definition>
</DefinitionList>
...
<ComponentCards>
  <ComponentCard componentId="headings" title="Headings" status="community" />
  <ComponentCard
